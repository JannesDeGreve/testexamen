...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    this.minimap = this.cameras
      ...
      .setZoom(0.1)
      .setName('mini');
    // this.minimap.scrollX = 750;
    // this.minimap.scrollY = 750;
    this.physics.world.setBounds(- 5, - 5, 1450, 1450);
  ...
  hpEvent() {
    if (this.hppacks.getChildren().length < 15 && this.hp < 100) {
      this.spawnHp();
    }
  ...
  spawnEnemy() {
    ...
    case 8:
      ...
      break;
    default:
      //console.log('geen enkele');
    }
  }

  // createHealthBar(enemy) {
  //   //console.log(enemy.x);
  //   this.healthBar = new Phaser.Geom.Rectangle(
  //     enemy.x,
  //     enemy.y - 10,
  //     (enemy.health * 30) / 2,
  //     2
  ...
  update() {
    ...
    if (!this.gameOver) {
      // this.minimapthis.vignette.destroy();
      // this.scoreTextField.destroy();
      // this.ammoTextField.destroy();
      // this.hpTextField.destroy();
      ...
      // this.minimap.scrollX = Phaser.Math.Clamp(this.player.x - 125, 700, 700);
      // this.minimap.scrollY = Phaser.Math.Clamp(this.player.x - 125, 700, 700);
